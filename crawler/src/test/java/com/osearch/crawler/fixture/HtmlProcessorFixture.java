...
public class HtmlProcessorFixture {
    public static final String URL_REGEX = "((http|https)://[\\w\\d:#@%/;$()~_?\\+-=\\\\\\.&]*)";
    public static final String INVALID_URL_REGEX = ".*\\.(js|txt|json|csv|pdf|xml|mp3|mp4|avi"
        + "|mov|zip|rar|exe|jpg|jpeg|gif|png|svg)$";
